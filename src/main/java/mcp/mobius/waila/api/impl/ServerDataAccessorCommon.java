...
public class ServerDataAccessorCommon implements IServerCommonAccessor, IServerDataAccessor, IServerEntityAccessor {
    ...
    public void set(WorldServer _world, EntityPlayerMP _player, Entity _entity) {
        this.set(_world, _player, null, 0, 0, 0, _entity);
    }

    public void set(WorldServer _world, EntityPlayerMP _player, TileEntity _tileEntity, int _x, int _y, int _z) {
        this.set(_world, _player, _tileEntity, x, y, z, null);
    }

    public void set(WorldServer _world, EntityPlayerMP _player,
