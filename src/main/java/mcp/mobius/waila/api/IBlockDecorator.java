...
public interface IBlockDecorator {
    ...
    /**
     * Client-side callback for the decorator. It provides a standard GL stack positioned on the block.</br>
     * Will be used if the implementing class is registered via {@link IRegistrar#registerDecorator}.</br>
     *
     * @param itemStack Current block scanned, in {@link ItemStack} form.
