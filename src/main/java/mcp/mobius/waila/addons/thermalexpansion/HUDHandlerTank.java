...
import static mcp.mobius.waila.addons.thermalexpansion.ThermalExpansionPlugin.TileTank_mode;
    ...
    public void modifyBody(ItemStack itemStack, ITaggedList<String, String> currenttip,
        ...
        try {
            if (config.get("thermalexpansion.tankmode")) {
                boolean mode = TileTank_mode.getBoolean(accessor.getTileEntity());
