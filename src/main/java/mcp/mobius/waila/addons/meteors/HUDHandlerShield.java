...
import static mcp.mobius.waila.addons.meteors.MeteorsPlugin.MeteorsMod_ShieldRadiusMultiplier;
import static mcp.mobius.waila.addons.meteors.MeteorsPlugin.MeteorsMod_instance;
        ...
        if (config.get("fm.radius"))
            try {
                ...
                if (meta == 0) {
                    ...
                    Object instance = MeteorsMod_instance.get(null);
                    if (instance != null) {
                        int srm = MeteorsMod_ShieldRadiusMultiplier.getInt(instance);
