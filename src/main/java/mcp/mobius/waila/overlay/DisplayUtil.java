...
public final class DisplayUtil {
    ...
    public static void drawRectFromIconIntern(Tessellator tessellator, int x, int y, double z, Icon icon,
                                              int width, int height) {
        drawRectIntern(tessellator, x, y, z, width, height, icon.getMinU(), icon.getMinV(),
