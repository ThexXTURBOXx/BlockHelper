...
public class ButtonBoolean extends ButtonBase {
    ...
    public ButtonBoolean(IWidget parent, String textFalse, String textTrue) {
        ...
        this.getWidget("LabelFalse").setGeometry(new WidgetGeometry(50.0D, 50.0D, 100.0D, 20.0D, CType.RELXY,
                CType.ABSXY, WAlign.CENTER, WAlign.CENTER));
        this.addWidget("LabelTrue", new LabelFixedFont(this, textTrue));
        this.getWidget("LabelTrue").hide();
        this.getWidget("LabelTrue").setGeometry(new WidgetGeometry(50.0D, 50.0D, 100.0D, 20.0D, CType.RELXY,
                CType.ABSXY, WAlign.CENTER, WAlign.CENTER));
    }
