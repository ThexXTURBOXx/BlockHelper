...
public class UIHelper {
    ...
    public static void drawBillboard(float posX, float posY, float posZ, float offX, float offY, float offZ,
                                     ...
                                     double partialFrame) {
        EntityLiving player = ModLoader.getMinecraftInstance().renderViewEntity;
        float playerViewY =
    ...
    public static void drawBillboard(float posX, float posY, float posZ, float offX, float offY, float offZ,
                                     float rotX, float rotY, float rotZ, double x1, double y1, double x2, double y2,
    ...
    public static void drawBillboardText(String text, Vec3D pos, float offX, float offY, float offZ,
                                         double partialFrame) {
    ...
    public static void drawFloatingText(String text, Vec3D pos, float offX, float offY, float offZ,
    ...
    public static void drawFloatingText(String text, float posX, float posY, float posZ,
        ...
        drawRectangle(-j - 1, 8 + b0, 0.0, j + 1, -1 + b0, 0.0, 0, 0, 0,
                64);
