...
public class NEIOverlayRenderer implements IRenderWorldLastHandler {
    ...
    // Let's not make this final in case some mod wants to change this...
    ...
    public void onRenderWorldLast(RenderGlobal renderer, float partialTicks) {
        ...
        Entity entity = ModLoader.getMinecraftInstance().renderViewEntity;
    ...
    private static void renderMobSpawnOverlay(Entity entity) {
        ...
        int y1 = (int) clamp(entity.posY, 16.0, worldHeight - 16);
