...
public class ButtonContainerLabel extends WidgetBase {
    ...
    public void addButton(ButtonBase button, String label) {
        ...
        this.getWidget(layoutName).setGeometry(new WidgetGeometry(sizeColumn * (column + 1), spacing * row,
        ...
        this.getWidget(layoutLabelName).setGeometry(new WidgetGeometry(sizeColumn * column, spacing * row,
                sizeColumn, spacing, CType.REL_X, CType.REL_X, WAlign.LEFT, WAlign.TOP));
