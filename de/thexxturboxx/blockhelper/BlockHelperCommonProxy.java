...
public class BlockHelperCommonProxy {
    ...
    public void load(mod_BlockHelper instance) {
        ...
        try {
            ...
            ccIntegration = cfg.get("General", "ChickenChunksIntegration", true).getBoolean(true);
            ...
            floraSomaIntegration = cfg.get("General", "FloraSomaIntegration", true).getBoolean(true);
            forestryIntegration = cfg.get("General", "ForestryIntegration", true).getBoolean(true);
            forgeIntegration = cfg.get("General", "ForgeIntegration", true).getBoolean(true);
            ...
            meteorsIntegration = cfg.get("General", "MeteorsIntegration", true).getBoolean(true);
            neiIntegration = cfg.get("General", "NEIIntegration", true).getBoolean(true);
            pamIntegration = cfg.get("General", "PamIntegration", true).getBoolean(true);
            projectZuluIntegration = cfg.get("General", "ProjectZuluIntegration", true).getBoolean(true);
