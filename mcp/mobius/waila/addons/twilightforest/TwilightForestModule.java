...
public class TwilightForestModule {
	...
	public static void register(){
		...
		try{
			...
			mod_BlockHelper.log.log(Level.INFO, "[TwilightForestMod] TwilightForestMod mod not found.");
			return;
		}
		...
		try {
			...
			mod_BlockHelper.log.log(Level.WARNING, "[TwilightForestMod] Class not found. " + e);
		}
