...
public class OpenBlocksModule {
	...
	public static void register(){
		try{
			...
			mod_BlockHelper.log.log(Level.INFO, "OpenBlocks mod found.");
		} catch (ClassNotFoundException e){
			mod_BlockHelper.log.log(Level.INFO, "[OpenBlocks] OpenBlocks mod not found.");
			return;
		}
		...
		try{
			...
			mod_BlockHelper.log.log(Level.WARNING, "[OpenBlocks] Class not found. " + e);
			return;
		}
