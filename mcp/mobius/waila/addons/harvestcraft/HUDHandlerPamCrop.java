...
public final class HUDHandlerPamCrop implements IDataProvider {

    public static final IDataProvider INSTANCE = new HUDHandlerPamCrop();

    private HUDHandlerPamCrop() {
    }
