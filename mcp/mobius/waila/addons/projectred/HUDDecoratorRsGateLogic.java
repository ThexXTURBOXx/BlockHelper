...
public class HUDDecoratorRsGateLogic implements IFMPDecorator {
    ...
    static byte[][] IOARRAY = {
            ...
            {11, 12, 11, 12} /* Inver */, {11, 12, 11, 12} /* Buff  */, {1, 9, 2, 8} /* Cmp    */,
            {1, 12, 2, 12} /* And   */,
    };
    ...
    public void decorateBlock(ItemStack itemStack, IFMPAccessor accessor, IPluginConfig config) {
        ...
        int shape = NBTUtil.getNBTInteger(accessor.getNBTData(), "shape");
        ...
        switch (vOrient) {
        case DOWN:
            UIHelper.drawFloatingText(IOStrRot[0], accessor.getRenderingPosition(), 0.5F, 0.2F, 1.4F, 90F, 0F, 0F);
            // Orient 0
            ...
            UIHelper.drawFloatingText(IOStrRot[3], accessor.getRenderingPosition(), 1.4F, 0.2F, 0.5F, 90F, 90F, 0F);
            // Orient 3
            break;
        case EAST:
