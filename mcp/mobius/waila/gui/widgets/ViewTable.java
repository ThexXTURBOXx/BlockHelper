...
public class ViewTable extends WidgetBase {
    ...
    public static class Cell extends WidgetBase {
        ...
        public Cell(IWidget parent, String text, WAlign align) {
            ...
            //this.addWidget("Crop", new LayoutCropping(null)).setGeometry(new WidgetGeometry(50.0, 50.0, 90.0, 100
            // .0, CType.RELXY, CType.RELXY, WAlign.CENTER, WAlign.CENTER));

            switch (align) {
            case CENTER:
                //this.getWidget("Crop").addWidget("Text", new LabelFixedFont(null, text))
                this.addWidget("Text", new LabelFixedFont(null, text))
                        .setGeometry(new WidgetGeometry(50.0, 50.0, 100.0, 100.0, CType.RELXY, CType.RELXY,
    ...
    public static class Row extends WidgetBase {
        ...
        public Row(IWidget parent) {
            ...
            this.addWidget("Background", new LayoutBase(null)).setGeometry(new WidgetGeometry(50.0, 50.0, 100.0,
