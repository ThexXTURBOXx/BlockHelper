...
public class ScreenConfig extends ScreenBase {
    public ScreenConfig(GuiScreen parent) {
        ...
        this.getRoot().getWidget("ButtonContainer").setGeometry(new WidgetGeometry(50.0, 50.0, 50.0, 30.0,
        ...
        buttonContainer.addButton(new ButtonScreenChange(this.getRoot(), "screen.button.waila",
                new ScreenWailaConfig(this)));
        buttonContainer.addButton(new ButtonScreenChange(this.getRoot(), "screen.button.modules",
                new ScreenModuleChoice(this)));
