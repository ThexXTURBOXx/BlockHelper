...
public class ScreenWailaConfig extends ScreenBase {
	public ScreenWailaConfig(GuiScreen parent){
		...
		buttonContainer.addButton( new ButtonBooleanConfig(this.getRoot(), Configuration.CATEGORY_GENERAL, Constants.CFG_WAILA_METADATA, true, true,"screen.button.hidden",     "screen.button.visible"), "choice.showhideidmeta");
