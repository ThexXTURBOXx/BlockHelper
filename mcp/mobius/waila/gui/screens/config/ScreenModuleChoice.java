...
public class ScreenModuleChoice extends ScreenBase {
    ...
    public ScreenModuleChoice(GuiScreen parent) {
        ...
        this.getRoot().getWidget("ButtonContainer").setGeometry(new WidgetGeometry(50.0, 20.0, 400.0, 60.0,
                CType.RELXY, CType.REL_Y, WAlign.CENTER, WAlign.TOP));

        ButtonContainer buttonContainer = ((ButtonContainer) this.getRoot().getWidget("ButtonContainer"));

        for (String key : PluginConfig.instance().getModuleNames())
