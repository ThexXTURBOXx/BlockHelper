...
public class ScreenTest extends ScreenBase {
    ...
    public ScreenTest(GuiScreen parent) {
        ...
        this.getRoot().addWidget("Test", new ViewTable(null))
                .setGeometry(new WidgetGeometry(50.0, 50.0, 90.0, 90.0, CType.RELXY, CType.RELXY, WAlign.CENTER,
                        WAlign.CENTER));
		...
		/*
		this.getRoot().addWidget("Test", new Row(null)).setGeometry(new WidgetGeometry(50.0, 50.0, 90.0, 20.0, CType
		.RELXY, CType.REL_X, WAlign.CENTER, WAlign.CENTER));
		...
		*/
        ...
        //this.getRoot().addWidget("TestLayout", new LayoutBase(null)).setGeometry(new WidgetGeometry(50.0, 50.0, 90
        // .0, 90.0, CType.RELXY, CType.RELXY, WAlign.CENTER, WAlign.CENTER));
        //((LayoutBase)this.getRoot().getWidget("TestLayout")).setBackgroundColors(0xff505050, 0xff505050);

        //this.getRoot().addWidget("Layout", new ViewportScrollable(null)).setGeometry(new WidgetGeometry(50.0,50.0,
        // 75.0,75.0,CType.RELXY, CType.RELXY, WAlign.CENTER, WAlign.CENTER));
        //((ViewportScrollable)this.getRoot().getWidget("Layout")).attachWidget(new PictureSwitch(this.getRoot(),
        // "/assets/waila/textures/test.png", "/assets/waila/textures/test_solar.png")).setSize(900, 900);
