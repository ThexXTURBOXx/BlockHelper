...
public class ScreenTest extends ScreenBase {
	...
	public ScreenTest(GuiScreen parent) {
		...
		*/
		...
		//((ViewportScrollable)this.getRoot().getWidget("Layout")).attachWidget(new PictureSwitch(this.getRoot(), "/assets/waila/textures/test.png", "/assets/waila/textures/test_solar.png")).setSize(900, 900);
